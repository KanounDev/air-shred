...
export function drawMenu(ctx: CanvasRenderingContext2D, width: number, height: number, nav: MenuNavState, trackingReady: boolean, now: number): void {
    ...
    ctx.shadowBlur = 16;
    ctx.fillText('AirShre', width / 2, height * 0.22);
    ctx.shadowBlur = 0;
